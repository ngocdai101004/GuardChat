...
def main() -> int:
    ...
    p.add_argument("--safe", type=str, default=None,
                   help="Local JSON of benign prompts (e.g. DiffusionDB) to add "
                        "as label-0 samples.")
    p.add_argument("--val", type=str, default=None,
                   help="Optional GuardChat val source (HF repo id or local file). "
    ...
    train_samples = load_guardchat(args.train, split=args.train_split)
    if args.safe:
